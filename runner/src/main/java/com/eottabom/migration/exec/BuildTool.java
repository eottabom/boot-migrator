...
/**
 * 대상 프로젝트의 빌드 실행. 실제로는 {@link TargetGradle} 이 대상 프로젝트의 gradlew 를 띄우고,
 * 러너 통합 테스트는 가짜 구현으로 실패 → 수정 → 재개 흐름을 재현한다.
 */
public interface BuildTool {
    ...
    /** rewriteRun / rewriteDryRun. configFile 은 선언형 레시피 파일 (.rewrite/rewrite.generated.yml), null 이면 플러그인 기본값 */
