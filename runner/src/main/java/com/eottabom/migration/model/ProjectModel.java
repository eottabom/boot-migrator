 ...
 * 대상 프로젝트의 현재 상태.
 *
 * @param bootVersion 루트 build.gradle(.kts) / gradle.properties 에서 찾은 Spring Boot 버전. 없으면
 * null
 ...
 * @param toolchainJava 빌드 파일에 선언된 toolchain / VERSION_NN 중 가장 높은 값 (Gradle 을 띄울 JDK 선택용).
 * 없으면 null
