...
public abstract class MigrationTask extends DefaultTask {
    ...
    protected Path projectDir() {
        ...
        Path dir = getInvocationDir().get().getAsFile().toPath().resolve(getProjectPath().get()).normalize().toAbsolutePath();
    ...
    protected MigrationRunner runner() {
        return new MigrationRunner(new MigrationRunner.RunnerPaths(
