 ...
 * <p>
 * upstream 의 {@code org.openrewrite.gradle.ChangeDependencyClassifier} 는 버전이 있는 문자열 리터럴만
 * 처리해서 실제 프로젝트에서 흔한 아래 형태를 바꾸지 못한다. <pre>
 ...
 * </pre> querydsl-apt 의 다른 classifier(general, hibernate, jdo 등)는 건드리지 않는다.
 */
